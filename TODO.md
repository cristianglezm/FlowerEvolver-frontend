## TODO
    ...
    * [x] add describe button to describe the flower.
    * [x] remove db.descriptions @ flower id when deleting flowers
    * [x] keep descriptions when deleting all flowers but favourites
    * [x] show progress bar when downloading model
